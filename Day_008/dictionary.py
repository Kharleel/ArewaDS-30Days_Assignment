# Exercise Day 8: 30 days of python programming
...
student = dict()
student.update({'first_name': 'Ibrahim', 'last_name': 'Suleiman','gender': 'male','age': 31,'marital_status': 'Married','skills':['MySQL','Java','Python'], 'country':'Nigeria','city': 'Kano','address': 'Kundila Zaria Road'})
