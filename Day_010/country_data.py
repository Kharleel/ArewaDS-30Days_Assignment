...
# Extract all languages spoken across countries into a list
for country_info in countries_data:
    all_languages.extend(country_info.get('languages', []))

# Use Counter to count occurrences of each language
...
print("The 10 most spoken languages are:", ", ".join(f"{language}: {count} occurrences" for language, count in top_10_languages))

# Find the 10 most populated countries in the world
# Sort countries_data based on 'population' in descending order
sorted_countries = sorted(countries_data, key=lambda x: x['population'], reverse=True)

# Get the top 10 most populated countries
top_10_populated_countries = sorted_countries[:10]

# Display the 10 most populated countries
